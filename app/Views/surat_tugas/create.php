...
<div class="premium-card" style="max-width: 900px; margin: 0 auto;">
    <div class="mb-4">
        ...
        <h5 class="m-0 font-display" style="font-weight: 700; color:#1e293b;">Terbitkan Surat Tugas Baru</h5>
        <p class="text-muted m-0" style="font-size: 13px;">Lengkapi data surat tugas dan tentukan personel yang didelegasikan.</p>
    </div>

    <form action="<?= base_url('surat-tugas/store') ?>" method="POST">
        <div class="row g-3">
            ...
            <div class="col-12 col-md-3">
                <div class="mb-3">
                    ...
                    <input type="date" name="tanggal_surat" id="tanggal_surat" class="form-control form-control-premium" required>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="mb-3">
                    ...
                    <textarea name="dasar_surat" id="dasar_surat" class="form-control form-control-premium" rows="3" placeholder="Contoh: DIPA Dinas Komunikasi dan Informatika Tahun Anggaran 2026..." required></textarea>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6">
                <div class="mb-3">
                    ...
                    <input type="text" name="maksud" id="maksud" class="form-control form-control-premium" placeholder="Contoh: Menghadiri Rapat Koordinasi IT" required autocomplete="off">
                </div>
            </div>
                ...
                <div class="mb-3">
                    ...
                    <div id="tujuan-container">
                        <div class="d-flex mb-2 align-items-center">
                            <input type="text" name="tujuan[]" class="form-control form-control-premium" placeholder="Tujuan 1 (Contoh: Banda Aceh)" required autocomplete="off">
            ...
            <div class="col-12 col-md-6">
                <div class="mb-3">
                    ...
                    <input type="date" name="tanggal_mulai" id="tanggal_mulai" class="form-control form-control-premium" required>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6">
                <div class="mb-3">
                    ...
                    <input type="date" name="tanggal_selesai" id="tanggal_selesai" class="form-control form-control-premium" required>
                </div>
            </div>
            ...
            <div class="col-12 mt-2">
                ...
                <div class="d-flex gap-4">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="hitung_sabtu" value="1" id="hitung_sabtu">
                        <label class="form-check-label" for="hitung_sabtu" style="font-size: 13.5px; color:#475569; cursor:pointer;">
                            Hitung Hari Sabtu
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="hitung_minggu" value="1" id="hitung_minggu">
            ...
            <div class="col-12 text-end mt-4">
                <button type="submit" class="btn btn-premium-primary px-4 py-2">
                    <i data-lucide="plane-takeoff" class="me-2"></i> Terbitkan Surat Tugas & SPPD
                </button>
            </div>
        </div>
    </form>
    ...
    if (btnAdd && container) {
        btnAdd.addEventListener('click', function() {
            ...
            div.querySelector('.btn-remove-tujuan').addEventListener('click', function() {
                ...
                // Re-index remaining optional placeholders
